        ...
        <div class="col-md-10">
             <div class="card" dir="rtl">
               @if(auth()->check() && auth()->user()->role === 'Admin'  && auth()->user()->status == '1')    
                <div class="card-header">تعديل جدول دراسي</div> <!-- Edit Schedule -->
                <div class="card-body">
                    <form method="POST" action="{{ route('schedules.update', $schedule->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">العنوان</label> <!-- Title -->
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $schedule->name }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="form-group row">
                            <label for="file_path" class="col-md-4 col-form-label text-md-right">File:</label> <!-- File -->
                            <div class="col-md-6">

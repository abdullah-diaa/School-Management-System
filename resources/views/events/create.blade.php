...
@section('content')
<link href="{{ asset('css/events/create.css') }}" rel="stylesheet">
        ...
        <div class="col-md-8">
            <div class="card" dir="rtl">
               @if(auth()->user()->role === 'Admin'  && auth()->user()->status == '1')
                <div class="card-header">إضافة حدث جديد</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="start_datetime" type="datetime-local" class="form-control @error('start_datetime') is-invalid @enderror" name="start_datetime" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="end_datetime" type="datetime-local" class="form-control @error('end_datetime') is-invalid @enderror" name="end_datetime" required>
                                @error('end_datetime')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
